...
#ifdef USEN_BAP
		TAS5806MD_Dac_Volume_Set(Switch_EQ_BSP_Mode, Aux_In_Exist()); //2023-06-12_1 : Fixed DAC Volume for AGL Enable depends on EQ Mode.
#endif
...
#ifdef USEN_BAP
		TAS5806MD_Dac_Volume_Set(Switch_EQ_NORMAL_Mode, Aux_In_Exist()); //2023-06-12_1 : Fixed DAC Volume for AGL Enable depends on EQ Mode.
#endif
#ifdef INPUT_KEY_SYNC_WITH_SLAVE_ENABLE
		MB3021_BT_Module_Input_Key_Sync_With_Slave(input_key_Sync_EQ, EQ_NORMAL_MODE);
#endif
