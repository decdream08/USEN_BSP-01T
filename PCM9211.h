...
#define PCM9211_ADC_CH_CTL_REG_GAIN_6DB				(0xE3) //+6db
#define PCM9211_ADC_CH_CTL_REG_GAIN_5D5DB			(0xE2) //+5.5db
#define PCM9211_ADC_CH_CTL_REG_GAIN_5DB			    (0xE1) //+5db
...
typedef enum {
	...
	PCM9211_MUTE_WAITING_WITH_SLAVE,
	PCM9211_INPUT_CHANGE,
	PCM9211_RUN,
}PCM92211_Status;
