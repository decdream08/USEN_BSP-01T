...
## 2023-06-13 (BAP-01)
  - Applied AGL for each mode(BT or Aux). //2023-06-13_1

## 2023-06-19 (BAP-01)
  - Changed AGL for each mode(EQ BSP + BT/EQ BSP + Aux/EQ NORMAL + BT/EQ NORMAL + AUX). //2023-06-19_1
...
## 2024-08-07 (BAP-02)
  - AC Outlet 연동 -> 비연동 (고객 사양 변경)
  - AC On시 BSP-01에서의 Pop 발생 문제 개선
...
## 2024-11-18 (BAP-02)
  - TP품에서 특정 레벨에서 볼륨 자동으로 변하는 문제 발생 -> ADC gab 조정
...
## 2024-11-27 (BAP-02)
  - 품질 요청 : Protection발생 시 BSP-01에서 출력 계속 됨 -> 출력이 발생안되도록 수정 요청
...
## 2024-12-23 (BAP-02)
  - AMP Fault protection 지연 처리 (define)

## 2024-12-24 (BAP-02)
  - 고객 요청 90Hz 24dB/oct 적용
  - 15Khz LPF 제거